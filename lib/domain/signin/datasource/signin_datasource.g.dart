...
part of 'signin_datasource.dart';
...
class _SignInDataSource implements SignInDataSource {
  _SignInDataSource(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<HttpResponse<Authentication>> signIn(
  ...
  @override
  Future<HttpResponse<Authentication>> refreshToken(
